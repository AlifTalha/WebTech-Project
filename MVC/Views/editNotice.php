...
<body>
    ...
    <div class="content">
        <form action="../Controllers/editNoticeCheckController.php" method="POST" id="registration-form">
            <h2 align="center">Edit Notice</h2>
            
            <input type="hidden" name="id" value="<?php echo ($notice) ? $notice['id'] : ''; ?>">

            <label for="name">Notice:</label>
            <input type="text" id="notice" name="notice" value="<?php echo ($notice) ? $notice['notice'] : ''; ?>">

            
            <label for="name">Date:</label>
            <input type="date" id="date" name="date" value="<?php echo ($notice) ? $notice['date'] : ''; ?>">
