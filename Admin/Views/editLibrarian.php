<?php
    ...
    $librarianId = isset($_GET['id']) ? $_GET['id'] : null;
...
<body>
    ...
    <div class="content">
        <form action="../Controllers/editLibrarianCheckController.php" method="POST" id="registration-form">
            <h2 align="center">Edit Librarian</h2>
            <input type="hidden" name="id" value="<?php echo ($librarian) ? $librarian['id'] : ''; ?>">
            
            <label for="name">Name:</label><br>
            <input type="text" id="name" name="name" value="<?php echo ($librarian) ? $librarian['name'] : ''; ?>"><br>

            <label for="email">Email:</label><br>
            <input type="text" id="email" name="email" value="<?php echo ($librarian) ? $librarian['email'] : ''; ?>"><br>

            <label for="mobile">Mobile No:</label><br>
            <input type="text" id="mobile" name="mobile" value="<?php echo ($librarian) ? $librarian['mobile'] : ''; ?>"><br>

            <label for="gender">Gender:</label><br>
            <select name="gender" id="gender">
                <option value="male" <?php echo ($librarian && $librarian['gender'] == 'male') ? 'selected' : ''; ?>>Male</option>
                <option value="female" <?php echo ($librarian && $librarian['gender'] == 'female') ? 'selected' : ''; ?>>Female</option>
                <option value="other" <?php echo ($librarian && $$librarian['gender'] == 'other') ? 'selected' : ''; ?>>Other</option>
            </select><br>

            <label for="dob">Date of Birth:</label><br>
            <input type="date" id="dob" name="dob" value="<?php echo ($librarian) ? $librarian['dob'] : ''; ?>"><br>
