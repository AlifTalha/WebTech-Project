<?php
	...
	$js = "../Script/addTeacher.js";
    // include("../Script/addTeacher.js");
...
<body>
    ...
    <div class="content">
    <form action="../Controllers/addTeacherCheckController.php" method="POST" id="registration-form" onsubmit="return validation()">
        ...
        <select name="subject" id="subject">
            ...
            <option value="Bangladesha and Global Study">Bangladesha and Global Study</option>
