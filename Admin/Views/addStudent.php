...
<body>
    ...
    <div class="content">
    <form action="../Controllers/addStudentCheckController.php" method="POST" id="registration-form">
        ...
        <input type="text" id="address" name="address" placeholder="Enter present address">
        ...
        <label for="name">Confirm Fees:</label>
        <input type="text" id="amount" name="amount" placeholder="Confirm fees">
