...
<head>
    ...
    <script>
        function ajax() {
            ...
            let table = document.getElementById('librarianTable');
                ...
                <tbody>
                    <?php foreach ($librarians as $librarian): ?>
                        <tr>
                            ...
                            <td>
                                <a href="editLibrarian.php?id=<?php echo $librarian['id']; ?>">Update</a>
                                <a href="../Controllers/deleteLibrarianCheckController.php?id=<?php echo $librarian['id']; ?>" onclick="return confirm('Are you sure you want to delete this librarian?');">Delete</a>
                            </td>
                        </tr>
                    <?php endforeach; ?>
                </tbody>
