                ...
                <tbody>
                    <?php foreach ($teachers as $teacher): ?>
                        <tr>
                            ...
                            <td>
                            <!-- Update button -->
                            <a href="editTeacher.php?id=<?php echo $teacher['id']; ?>">Update</a>
                            <!-- Delete button -->
                            <!-- <a href="../Controllers/deleteTeacherCheckController.php?id=<?php echo $teacher['id']; ?>" onclick="return confirm('Are you sure you want to delete this teacher?');">Delete</a> -->
                            <a href="../Controllers/deleteTeacherCheckController.php?id=<?php echo $teacher['id']; ?>" onclick="return confirm('Are you sure you want to delete this teacher?');">Delete</a>
                            <!-- <a href="deleteTeacher.php?id=<?php echo $teacher['id']; ?>">Delete</a> -->
                            </td>
                        </tr>
                    <?php endforeach; ?>
                </tbody>
