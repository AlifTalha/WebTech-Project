...
<body>
    ...
    <div class="content">
        <form action="../Controllers/editProfileCheckController.php" method="POST" id="edit-course-form">
            <h2 align="center">Edit Profile</h2>
            <input type="hidden" name="id" value="<?php echo ($profile) ? $profile['id'] : ''; ?>">
            
            <label for="name">Name:</label><br>
            <input type="text" id="name" name="name" value="<?php echo ($profile) ? $profile['name'] : ''; ?>"><br>

            <label for="name">Email:</label><br>
            <input type="text" id="email" name="email" value="<?php echo ($profile) ? $profile['email'] : ''; ?>"><br>
