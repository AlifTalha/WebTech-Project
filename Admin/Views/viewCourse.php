...
<body>
    ...
    <div class="content">
        <div class="dashboard-table">
            <h2 style="text-align: left;">Number of Courses</h2>
                ...
                <tbody>
                    <?php foreach ($courses as $course): ?>
                        <tr>
                            ...
                            <td>
                                <a href="editCourse.php?id=<?php echo $course['id']; ?>">Update</a>
                                <a href="../Controllers/deleteCourseCheckController.php?id=<?php echo $course['id']; ?>" onclick="return confirm('Are you sure you want to delete this course?');">Delete</a>
                            </td>
                        </tr>
                    <?php endforeach; ?>
                </tbody>
