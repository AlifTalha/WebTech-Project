...
<body>
    ...
    <div class="content">
        <form action="../Controllers/editTeacherCheckController.php" method="POST" id="registration-form">
            <h2 align="center">Edit Teacher</h2>
            <input type="hidden" name="id" value="<?php echo ($teacher) ? $teacher['id'] : ''; ?>">
            
            <label for="name">Name:</label><br>
            <input type="text" id="name" name="name" value="<?php echo ($teacher) ? $teacher['name'] : ''; ?>"><br>

            <label for="email">Email:</label><br>
            <input type="text" id="email" name="email" value="<?php echo ($teacher) ? $teacher['email'] : ''; ?>"><br>

            <label for="mobile">Mobile No:</label><br>
            <input type="text" id="mobile" name="mobile" value="<?php echo ($teacher) ? $teacher['mobile'] : ''; ?>"><br>

            <label for="gender">Gender:</label><br>
            <select name="gender" id="gender">
                <option value="male" <?php echo ($teacher && $teacher['gender'] == 'male') ? 'selected' : ''; ?>>Male</option>
                <option value="female" <?php echo ($teacher && $teacher['gender'] == 'female') ? 'selected' : ''; ?>>Female</option>
                <option value="other" <?php echo ($teacher && $teacher['gender'] == 'other') ? 'selected' : ''; ?>>Other</option>
            </select><br>

            <label for="dob">Date of Birth:</label><br>
            <input type="date" id="dob" name="dob" value="<?php echo ($teacher) ? $teacher['dob'] : ''; ?>"><br>

            <label for="subject">Subject:</label><br>
            <select name="subject" id="subject">
                <option value="Bangla" <?php echo ($teacher && $teacher['subject'] == 'Bangla') ? 'selected' : ''; ?>>Bangla</option>
                <option value="English" <?php echo ($teacher && $teacher['subject'] == 'English') ? 'selected' : ''; ?>>English</option>
                <option value="Math" <?php echo ($teacher && $teacher['subject'] == 'Math') ? 'selected' : ''; ?>>Math</option>
                <option value="Bangladesha and Global Study" <?php echo ($teacher && $teacher['subject'] == 'Bangladesha and Global Study') ? 'selected' : ''; ?>>Bangladesha and Global Study</option>
                <option value="Religion" <?php echo ($teacher && $teacher['subject'] == 'Religion') ? 'selected' : ''; ?>>Religion</option>
                <option value="Science" <?php echo ($teacher && $teacher['subject'] == 'Science') ? 'selected' : ''; ?>>Science</option>
            </select><br>
