<?php
    ...
    class user
        {
            ...
            {
                $this->db=new mysqli(hostname: DB_SERVER,username: DB_USERNAME,password: DB_PASSWORD,database: 'hotel');
   ...
   FROM rooms WHERE checkin <= '$checkin' AND checkout >='$checkout'))";
            ...
            public function submit_review($name, $contact_number, $comment, $rating) {
                $sql = "INSERT INTO reviews (name, contact_number, comment, rating) VALUES ('$name', '$contact_number', '$comment', '$rating')";
