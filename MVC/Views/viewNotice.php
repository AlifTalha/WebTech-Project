<?php
    ...
    // $noticetId = isset($_GET['id']) ? $_GET['id'] : null;
    // require_once('../Models/userModel.php');
    // $noticeEdit = getNoticeById($noticetId);
...
<body>
    ...
    <div class="side-menu">
        ...
        <div class="dashboard-table">
            <h2 colspan="2" style="text-align: left;">Number of Notices</h2>
                ...
                <tbody>
                    <?php foreach ($notices as $notice): ?>
                        <tr>
                            ...
                            <td>
                                <a href="editNotice.php?id=<?php echo $notice['id']; ?>">Update</a>
                                <a href="../Controllers/deleteNoticeCheckController.php?id=<?php echo $notice['id']; ?>" onclick="return confirm('Are you sure you want to delete this notice?');">Delete</a>
                            </td>
                        </tr>
                    <?php endforeach; ?>
                </tbody>
